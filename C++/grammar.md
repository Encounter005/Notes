...
<!-- vim-markdown-toc GFM -->
  ...
  * [类](#类)
    ...
    * [(\*\*\*)类的继承](#类的继承)
      ...
      * [注意事项](#注意事项)
      * [总结](#总结-1)
    * [(**)虚函数及其实现原理， overide关键字](#虚函数及其实现原理-overide关键字)
      * [介绍](#介绍-1)
      * [注意事项](#注意事项-1)
...
C++继承原理: C++的继承可以理解为在创建子类成员把变量之前先创建父类的成员变量，实际上，C语言就是这么模仿出来的
...
1. 子父类的虚函数必须完全相同，为了防止开发人员一不小心将函数写错，于是有了override关键字
